import 'dart:convert';
/// updated : 1688504985981
/// cases : 690991162
/// todayCases : 5214
/// deaths : 6896251
/// todayDeaths : 91
/// recovered : 663659786
/// todayRecovered : 27010
/// active : 20435125
/// critical : 37293
/// casesPerOneMillion : 88648
/// deathsPerOneMillion : 884.7
/// tests : 6997060170
/// testsPerOneMillion : 880694.44
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2572.09
/// recoveredPerOneMillion : 83532.44
/// criticalPerOneMillion : 4.69
/// affectedCountries : 231

WorldStatesModel worldStatesMdelFromJson(String str) => WorldStatesModel.fromJson(json.decode(str));
String worldStatesMdelToJson(WorldStatesModel data) => json.encode(data.toJson());
